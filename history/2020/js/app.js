...
/* ========================= ORDER MODAL ============================= */
/* =============================================================== */
const orders =checkUp(document.querySelectorAll("form button"));
...
function setModal(flavour, parent){
  ...
  let template = `
    <div class="cust-modal flexy-col">
      <div class="cust-header" onclick="closeModal()"><h3> X </h3></div>
      <aside>
      ...
      <div class="cust-footer" onclick="closeModal()"><h3> X </h3></div>
    </div>
  `;
